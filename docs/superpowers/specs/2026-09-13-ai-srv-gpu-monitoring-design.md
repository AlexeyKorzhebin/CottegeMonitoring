...
- −1 на графиках не прятать: это сигнал дыры. Цвета плиток/графика: температура <60 зелёный, 60–75 жёлтый, 75–80 оранжевый, >80 красный; RPM 0–2000 зелёный, ≥3500 красный; PWM 0–100 зелёный, ≥180 красный. Защита GPU 84 °C — firmware, без Telegram-алерта в этой волне.
