...
| нагрей чайник до 80 | `set_kettle` setpoint_c=80 | пишет объект уставки, не cmd 33/1/39 |
| скажи температуру чайника | `get_kettle` | … 36 °C (temp); setpoint_c если объект есть |
