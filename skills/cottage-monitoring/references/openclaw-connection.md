...
Live `TOOLS.md` агента `cottage` (`workspace-cottage/TOOLS.md`) — native MCP only. Канон: `specs/001-server-mqtt-ingestor/openclaw-cottage-tools.md`. mcporter в этом файле не путь агента.
